...
public class Utilities {
    ...
    public static ArrayList<Coin> fetchCoins(String coinUrl) throws JSONException {
        ...
        for(int i=0;i<baseArr.length();i++) {
            ...
            JSONObject coinObj = baseArr.getJSONObject(i);

            String coinName = coinObj.getString("name");
            Log.i("coinName",""+coinName);

            String coinSymbol = coinObj.getString("symbol");
            Log.i("coin symbol",""+coinSymbol);

            String coinPrice = coinObj.getString("price_usd");
            Log.i("price",""+coinPrice);

            String coinPercent = coinObj.getString("percent_change_24h");
            Log.i("percent",""+coinPercent);

            coinList.add(new Coin(coinName, coinSymbol, coinPrice, coinPercent, "" ));
        }
